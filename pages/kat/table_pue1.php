			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-left"><p>Пространство в помещениях, в которых при нормальной эксплуатации взрывоопасные смеси ГГ или паров ЛВЖ с воздухом 
						не образуются, а возможны только в результате аварий или неисправностей и которые отличаются одной из следующих особенностей:</p>
							<ol>
