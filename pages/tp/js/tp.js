...
function kadr4(){
    ...
    bt_sh.addEventListener('click', ()=>{
       ...
       _stage = null;
        ...
        //кнопка "Следующее направление" появляется после отрисовки canvas
        //попробовать реализовать: после отрисовки генерируется событие и в результате делаем кнопку
        bt_sh.addEventListener('click', ()=>{
            console.log('hello');
        });
